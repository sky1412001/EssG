...
import { SafeAreaView, ScrollView, View , Text, StatusBar, Image, TouchableOpacity} from "react-native";
    ...
    return(
        <SafeAreaView>
            ...
            <StatusBar translucent backgroundColor={'rgba(0,0,0,0)'}/>
                <View style={{height:120, backgroundColor:"rgb(250, 249, 246)", padding:30, flexDirection:"row", gap:20}}>
                ...
                <View style={{backgroundColor:COLORS.og, padding:10}}>
